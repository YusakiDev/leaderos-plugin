...
public class BazaarGui {
    ...
    public static void showGui(Player player) {
        ...
        Bukkit.getFoliaLib().getScheduler().runAsync((showGuiTask) -> {
                ...
                playerBazaarList.forEach(playerBazaarItem -> {
                            ...
                            bazaarGui.addElement(new DynamicGuiElement('s', (viewer)
                                    ...
                                    click -> {
                                        ...
                                        Bukkit.getFoliaLib().getScheduler().runAsync((withdrawTask) -> {
            ...
            Bukkit.getFoliaLib().getScheduler().runNextTick((guiShowTask) -> {
                gui.show(player);
            });
